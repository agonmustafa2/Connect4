//Pjesa e deklarimit te variablave
...
//funksioni qe na mundeson me kliku ne squares
...
//funksioni qe e shikon pas qdo levizje nese loja ka fitues
...
let squares =document.querySelectorAll(".board div")
	for (let y=0;y<winningArray.length;y++)
	{
		...
		if(square.every(q=>squares[q].classList.contains("player-one"))){
  		...
  		{
  			setTimeout(() =>alert("player two(black) wins"), 200)
  			setTimeout(() =>restart.style.display="flex", 500)
		}
	}
}

//funksioni qe e bon reset lojen pasi te perfundohet loja
function reset()
{
	board.innerHTML="" 
	loadDOM() 
